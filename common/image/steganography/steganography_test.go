...
var rawInputFilePng = "./testdata/stegosaurus.png"
var rawInputFileJpg = "./testdata/stegosaurus.jpg"
var encodedInputFilePng = "./testdata/encoded_stegosaurus.png"
var encodedInputFileJpg = "./testdata/encoded_stegosaurus.jpg"
...
func TestEncodeFromPngFile(t *testing.T) {
	...
	newimg, err := Encode(img, bitmessage)
	if err != nil {
...
func TestEncodeFromJpgFile(t *testing.T) {
	...
	newimg, err := Encode(img, bitmessage) // Encode the message into the image file
	if err != nil {
		log.Printf("Error Encoding file %v", err)
		t.FailNow()
...
func TestEncodeDecodeGeneratedSmallImage(t *testing.T) {
	...
	err := EncodeNRGBA(newimg, []uint8{84, 84, 84}) // Encode the message into the image file
	if err != nil {
		log.Printf("Error Encoding file %v", err)
		t.FailNow()
	}
...
func TestMessageTooLarge(t *testing.T) {
	...
	_, err := Encode(miniImage, bitmessage) // Encode the message into the image file
	if err == nil {
