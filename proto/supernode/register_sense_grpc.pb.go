...
type RegisterSenseClient interface {
	...
	SendSignedDDAndFingerprints(ctx context.Context, in *SenseSendSignedDDAndFingerprintsRequest, opts ...grpc.CallOption) (*SenseSendSignedDDAndFingerprintsReply, error)
	// SendArtTicketSignature send signature from supernodes mn2/mn3 for given reg NFT session id to primary supernode
	SendArtTicketSignature(ctx context.Context, in *SenseSendArtTicketSignatureRequest, opts ...grpc.CallOption) (*SenseSendArtTicketSignatureReply, error)
}
...
func (c *registerSenseClient) Session(ctx context.Context, opts ...grpc.CallOption) (RegisterSense_SessionClient, error) {
	stream, err := c.cc.NewStream(ctx, &RegisterSense_ServiceDesc.Streams[0], "/supernode.RegisterSense/Session", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *registerSenseClient) SendSignedDDAndFingerprints(ctx context.Context, in *SenseSendSignedDDAndFingerprintsRequest, opts ...grpc.CallOption) (*SenseSendSignedDDAndFingerprintsReply, error) {
	out := new(SenseSendSignedDDAndFingerprintsReply)
	err := c.cc.Invoke(ctx, "/supernode.RegisterSense/SendSignedDDAndFingerprints", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registerSenseClient) SendArtTicketSignature(ctx context.Context, in *SenseSendArtTicketSignatureRequest, opts ...grpc.CallOption) (*SenseSendArtTicketSignatureReply, error) {
	out := new(SenseSendArtTicketSignatureReply)
...
type RegisterSenseServer interface {
	...
	// SendSignedDDAndFingerprints send its SignedDDAndFingerprints to other node
	SendSignedDDAndFingerprints(context.Context, *SenseSendSignedDDAndFingerprintsRequest) (*SenseSendSignedDDAndFingerprintsReply, error)
	// SendArtTicketSignature send signature from supernodes mn2/mn3 for given reg NFT session id to primary supernode
	SendArtTicketSignature(context.Context, *SenseSendArtTicketSignatureRequest) (*SenseSendArtTicketSignatureReply, error)
...
func (UnimplementedRegisterSenseServer) SendSignedDDAndFingerprints(context.Context, *SenseSendSignedDDAndFingerprintsRequest) (*SenseSendSignedDDAndFingerprintsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendSignedDDAndFingerprints not implemented")
}
func (UnimplementedRegisterSenseServer) SendArtTicketSignature(context.Context, *SenseSendArtTicketSignatureRequest) (*SenseSendArtTicketSignatureReply, error) {
...
func _RegisterSense_SendSignedDDAndFingerprints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SenseSendSignedDDAndFingerprintsRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supernode.RegisterSense/SendSignedDDAndFingerprints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterSenseServer).SendSignedDDAndFingerprints(ctx, req.(*SenseSendSignedDDAndFingerprintsRequest))
	}
...
func _RegisterSense_SendArtTicketSignature_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SenseSendArtTicketSignatureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterSenseServer).SendArtTicketSignature(ctx, req.(*SenseSendArtTicketSignatureRequest))
	}
	return interceptor(ctx, in, info, handler)
}
