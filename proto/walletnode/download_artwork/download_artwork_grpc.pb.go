...
func (c *downloadArtworkClient) Download(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (DownloadArtwork_DownloadClient, error) {
	stream, err := c.cc.NewStream(ctx, &DownloadArtwork_ServiceDesc.Streams[0], "/download_artwork.DownloadArtwork/Download", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *downloadArtworkClient) DownloadThumbnail(ctx context.Context, in *DownloadThumbnailRequest, opts ...grpc.CallOption) (*DownloadThumbnailReply, error) {
	...
	err := c.cc.Invoke(ctx, "/download_artwork.DownloadArtwork/DownloadThumbnail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DownloadArtwork_DownloadThumbnail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/download_artwork.DownloadArtwork/DownloadThumbnail",
	}
...
var DownloadArtwork_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "download_artwork.DownloadArtwork",
