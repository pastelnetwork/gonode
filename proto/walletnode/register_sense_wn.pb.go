...
var file_register_sense_wn_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x46, 0x70, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x32, 0xe6, 0x05, 0x0a, 0x0d, 0x52, 0x65,
...
var file_register_sense_wn_proto_goTypes = []interface{}{
	...
	(*SessionReply)(nil),                 // 9: walletnode.SessionReply
	(*AcceptedNodesReply)(nil),           // 10: walletnode.AcceptedNodesReply
	(*ConnectToReply)(nil),               // 11: walletnode.ConnectToReply
	(*MeshNodesReply)(nil),               // 12: walletnode.MeshNodesReply
	(*SendRegMetadataReply)(nil),         // 13: walletnode.SendRegMetadataReply
	(*ProbeImageReply)(nil),              // 14: walletnode.ProbeImageReply
	(*SendSignedActionTicketReply)(nil),  // 15: walletnode.SendSignedActionTicketReply
	(*SendActionActReply)(nil),           // 16: walletnode.SendActionActReply
...
var file_register_sense_wn_proto_depIdxs = []int32{
	...
	9,  // 9: walletnode.RegisterSense.Session:output_type -> walletnode.SessionReply
	10, // 10: walletnode.RegisterSense.AcceptedNodes:output_type -> walletnode.AcceptedNodesReply
	11, // 11: walletnode.RegisterSense.ConnectTo:output_type -> walletnode.ConnectToReply
	12, // 12: walletnode.RegisterSense.MeshNodes:output_type -> walletnode.MeshNodesReply
	13, // 13: walletnode.RegisterSense.SendRegMetadata:output_type -> walletnode.SendRegMetadataReply
	14, // 14: walletnode.RegisterSense.ProbeImage:output_type -> walletnode.ProbeImageReply
	15, // 15: walletnode.RegisterSense.SendSignedActionTicket:output_type -> walletnode.SendSignedActionTicketReply
	16, // 16: walletnode.RegisterSense.SendActionAct:output_type -> walletnode.SendActionActReply
	17, // 17: walletnode.RegisterSense.GetDDDatabaseHash:output_type -> walletnode.DBHashReply
