...
var file_register_sense_wn_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x46, 0x70, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x32, 0x9a, 0x05, 0x0a, 0x0d, 0x52, 0x65,
...
var file_register_sense_wn_proto_goTypes = []interface{}{
	...
	(*ProbeImageReply)(nil),              // 13: walletnode.ProbeImageReply
	(*SendSignedActionTicketReply)(nil),  // 14: walletnode.SendSignedActionTicketReply
...
var file_register_sense_wn_proto_depIdxs = []int32{
	...
	8,  // 8: walletnode.RegisterSense.Session:output_type -> walletnode.SessionReply
	9,  // 9: walletnode.RegisterSense.AcceptedNodes:output_type -> walletnode.AcceptedNodesReply
	10, // 10: walletnode.RegisterSense.ConnectTo:output_type -> walletnode.ConnectToReply
	11, // 11: walletnode.RegisterSense.MeshNodes:output_type -> walletnode.MeshNodesReply
	12, // 12: walletnode.RegisterSense.SendRegMetadata:output_type -> walletnode.SendRegMetadataReply
	13, // 13: walletnode.RegisterSense.ProbeImage:output_type -> walletnode.ProbeImageReply
	14, // 14: walletnode.RegisterSense.SendSignedActionTicket:output_type -> walletnode.SendSignedActionTicketReply
	15, // 15: walletnode.RegisterSense.SendActionAct:output_type -> walletnode.SendActionActReply
