...
type RegisterArtworkRequest struct {
	...
	//	*RegisterArtworkRequest_PrimaryAcceptSecondary
	//	*RegisterArtworkRequest_SecondaryConnectToPrimary
...
func (x *RegisterArtworkRequest) GetPrimaryAcceptSecondary() *RegisterArtworkRequest_PrimaryAcceptSecondaryRequest {
	if x, ok := x.GetRequests().(*RegisterArtworkRequest_PrimaryAcceptSecondary); ok {
		return x.PrimaryAcceptSecondary
	}
	return nil
}

func (x *RegisterArtworkRequest) GetSecondaryConnectToPrimary() *RegisterArtworkRequest_SecondaryConnectToPrimaryRequest {
	if x, ok := x.GetRequests().(*RegisterArtworkRequest_SecondaryConnectToPrimary); ok {
		return x.SecondaryConnectToPrimary
	}
	return nil
}
...
type RegisterArtworkRequest_PrimaryAcceptSecondary struct {
	PrimaryAcceptSecondary *RegisterArtworkRequest_PrimaryAcceptSecondaryRequest `protobuf:"bytes,2,opt,name=primary_accept_secondary,json=primaryAcceptSecondary,proto3,oneof"`
}

type RegisterArtworkRequest_SecondaryConnectToPrimary struct {
	SecondaryConnectToPrimary *RegisterArtworkRequest_SecondaryConnectToPrimaryRequest `protobuf:"bytes,3,opt,name=secondary_connect_to_primary,json=secondaryConnectToPrimary,proto3,oneof"`
}
...
func (*RegisterArtworkRequest_PrimaryAcceptSecondary) isRegisterArtworkRequest_Requests() {}

func (*RegisterArtworkRequest_SecondaryConnectToPrimary) isRegisterArtworkRequest_Requests() {}
...
type RegisterArtworkReply struct {
	...
	//	*RegisterArtworkReply_PrimayAcceptSecondary
	//	*RegisterArtworkReply_SecondaryConnectToPrimary
...
func (x *RegisterArtworkReply) GetPrimayAcceptSecondary() *RegisterArtworkReply_PrimaryAcceptSecondaryReply {
	if x, ok := x.GetReplies().(*RegisterArtworkReply_PrimayAcceptSecondary); ok {
		return x.PrimayAcceptSecondary
	}
	return nil
}

func (x *RegisterArtworkReply) GetSecondaryConnectToPrimary() *RegisterArtworkReply_SecondaryConnectToPrimaryReply {
	if x, ok := x.GetReplies().(*RegisterArtworkReply_SecondaryConnectToPrimary); ok {
		return x.SecondaryConnectToPrimary
	}
	return nil
}
...
type RegisterArtworkReply_PrimayAcceptSecondary struct {
	PrimayAcceptSecondary *RegisterArtworkReply_PrimaryAcceptSecondaryReply `protobuf:"bytes,2,opt,name=primay_accept_secondary,json=primayAcceptSecondary,proto3,oneof"`
}

type RegisterArtworkReply_SecondaryConnectToPrimary struct {
	SecondaryConnectToPrimary *RegisterArtworkReply_SecondaryConnectToPrimaryReply `protobuf:"bytes,3,opt,name=secondary_connect_to_primary,json=secondaryConnectToPrimary,proto3,oneof"`
}
...
func (*RegisterArtworkReply_PrimayAcceptSecondary) isRegisterArtworkReply_Replies() {}

func (*RegisterArtworkReply_SecondaryConnectToPrimary) isRegisterArtworkReply_Replies() {}
...
type RegisterArtworkRequest_PrimaryAcceptSecondaryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *RegisterArtworkRequest_PrimaryAcceptSecondaryRequest) Reset() {
	*x = RegisterArtworkRequest_PrimaryAcceptSecondaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkRequest_PrimaryAcceptSecondaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkRequest_PrimaryAcceptSecondaryRequest) ProtoMessage() {}

func (x *RegisterArtworkRequest_PrimaryAcceptSecondaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkRequest_PrimaryAcceptSecondaryRequest.ProtoReflect.Descriptor instead.
func (*RegisterArtworkRequest_PrimaryAcceptSecondaryRequest) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{0, 1}
}

type RegisterArtworkRequest_SecondaryConnectToPrimaryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterArtworkRequest_SecondaryConnectToPrimaryRequest) Reset() {
	*x = RegisterArtworkRequest_SecondaryConnectToPrimaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkRequest_SecondaryConnectToPrimaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkRequest_SecondaryConnectToPrimaryRequest) ProtoMessage() {}

func (x *RegisterArtworkRequest_SecondaryConnectToPrimaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkRequest_SecondaryConnectToPrimaryRequest.ProtoReflect.Descriptor instead.
func (*RegisterArtworkRequest_SecondaryConnectToPrimaryRequest) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{0, 2}
}

func (x *RegisterArtworkRequest_SecondaryConnectToPrimaryRequest) GetNodeKey() string {
	if x != nil {
		return x.NodeKey
	}
	return ""
...
type RegisterArtworkReply_PrimaryAcceptSecondaryReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Peers []*RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer `protobuf:"bytes,1,rep,name=peers,proto3" json:"peers,omitempty"`
	Error *RegisterArtworkReply_Error                              `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}

func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply) Reset() {
	*x = RegisterArtworkReply_PrimaryAcceptSecondaryReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkReply_PrimaryAcceptSecondaryReply) ProtoMessage() {}

func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkReply_PrimaryAcceptSecondaryReply.ProtoReflect.Descriptor instead.
func (*RegisterArtworkReply_PrimaryAcceptSecondaryReply) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{1, 2}
}

func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply) GetPeers() []*RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer {
	if x != nil {
		return x.Peers
	}
	return nil
...
func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply) GetError() *RegisterArtworkReply_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type RegisterArtworkReply_SecondaryConnectToPrimaryReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterArtworkReply_SecondaryConnectToPrimaryReply) Reset() {
	*x = RegisterArtworkReply_SecondaryConnectToPrimaryReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkReply_SecondaryConnectToPrimaryReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkReply_SecondaryConnectToPrimaryReply) ProtoMessage() {}

func (x *RegisterArtworkReply_SecondaryConnectToPrimaryReply) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkReply_SecondaryConnectToPrimaryReply.ProtoReflect.Descriptor instead.
func (*RegisterArtworkReply_SecondaryConnectToPrimaryReply) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{1, 3}
}

func (x *RegisterArtworkReply_SecondaryConnectToPrimaryReply) GetError() *RegisterArtworkReply_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer) Reset() {
	*x = RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer) ProtoMessage() {}

func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer.ProtoReflect.Descriptor instead.
func (*RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{1, 2, 0}
}

func (x *RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer) GetNodeKey() string {
	if x != nil {
		return x.NodeKey
	}
	return ""
...
var file_walletnode_walletnode_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x6c, 0x65, 0x74, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0xd9, 0x07, 0x0a, 0x16, 0x52, 0x65,
	...
	,
	...
	,
	...
	0x69, 0x63, 0x6b, 0x65, 0x74, 0x1a, 0x49, 0x0a, 0x10, 0x48, 0x61, 0x6e, 0x64, 0x73, 0x68, 0x61,
	...
	0x44, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73, 0x5f, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79,
	0x1a, 0x1f, 0x0a, 0x1d, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x41, 0x63, 0x63, 0x65, 0x70,
	0x74, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x3d, 0x0a, 0x20, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x43, 0x6f,
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x54, 0x6f, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x52, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_walletnode_walletnode_proto_goTypes = []interface{}{
	...
	(*RegisterArtworkRequest_PrimaryAcceptSecondaryRequest)(nil),    // 4: walletnode.RegisterArtworkRequest.PrimaryAcceptSecondaryRequest
	(*RegisterArtworkRequest_SecondaryConnectToPrimaryRequest)(nil), // 5: walletnode.RegisterArtworkRequest.SecondaryConnectToPrimaryRequest
	...
	(*RegisterArtworkReply_PrimaryAcceptSecondaryReply)(nil),        // 10: walletnode.RegisterArtworkReply.PrimaryAcceptSecondaryReply
	(*RegisterArtworkReply_SecondaryConnectToPrimaryReply)(nil),     // 11: walletnode.RegisterArtworkReply.SecondaryConnectToPrimaryReply
	...
	(*RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer)(nil),   // 14: walletnode.RegisterArtworkReply.PrimaryAcceptSecondaryReply.Peer
}
var file_walletnode_walletnode_proto_depIdxs = []int32{
	...
	4,  // 1: walletnode.RegisterArtworkRequest.primary_accept_secondary:type_name -> walletnode.RegisterArtworkRequest.PrimaryAcceptSecondaryRequest
	5,  // 2: walletnode.RegisterArtworkRequest.secondary_connect_to_primary:type_name -> walletnode.RegisterArtworkRequest.SecondaryConnectToPrimaryRequest
	...
	10, // 6: walletnode.RegisterArtworkReply.primay_accept_secondary:type_name -> walletnode.RegisterArtworkReply.PrimaryAcceptSecondaryReply
	11, // 7: walletnode.RegisterArtworkReply.secondary_connect_to_primary:type_name -> walletnode.RegisterArtworkReply.SecondaryConnectToPrimaryReply
	...
	14, // 12: walletnode.RegisterArtworkReply.PrimaryAcceptSecondaryReply.peers:type_name -> walletnode.RegisterArtworkReply.PrimaryAcceptSecondaryReply.Peer
	8,  // 13: walletnode.RegisterArtworkReply.PrimaryAcceptSecondaryReply.error:type_name -> walletnode.RegisterArtworkReply.Error
	8,  // 14: walletnode.RegisterArtworkReply.SecondaryConnectToPrimaryReply.error:type_name -> walletnode.RegisterArtworkReply.Error
...
func file_walletnode_walletnode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_walletnode_walletnode_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkRequest_PrimaryAcceptSecondaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkRequest_SecondaryConnectToPrimaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkReply_PrimaryAcceptSecondaryReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkReply_SecondaryConnectToPrimaryReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkReply_PrimaryAcceptSecondaryReply_Peer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_walletnode_walletnode_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*RegisterArtworkRequest_PrimaryAcceptSecondary)(nil),
		(*RegisterArtworkRequest_SecondaryConnectToPrimary)(nil),
	...
	file_walletnode_walletnode_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*RegisterArtworkReply_PrimayAcceptSecondary)(nil),
		(*RegisterArtworkReply_SecondaryConnectToPrimary)(nil),
