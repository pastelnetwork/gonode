...
type RegisterArtworkRequest struct {
	...
	//	*RegisterArtworkRequest_SecondaryNodes
	//	*RegisterArtworkRequest_ConnectToPrimary
...
func (x *RegisterArtworkRequest) GetSecondaryNodes() *RegisterArtworkRequest_SecondaryNodesRequest {
	if x, ok := x.GetRequests().(*RegisterArtworkRequest_SecondaryNodes); ok {
		return x.SecondaryNodes
	}
	return nil
}

func (x *RegisterArtworkRequest) GetConnectToPrimary() *RegisterArtworkRequest_ConnectToPrimaryRequest {
	if x, ok := x.GetRequests().(*RegisterArtworkRequest_ConnectToPrimary); ok {
		return x.ConnectToPrimary
	}
	return nil
}
...
type RegisterArtworkRequest_SecondaryNodes struct {
	SecondaryNodes *RegisterArtworkRequest_SecondaryNodesRequest `protobuf:"bytes,2,opt,name=secondary_nodes,json=secondaryNodes,proto3,oneof"`
}

type RegisterArtworkRequest_ConnectToPrimary struct {
	ConnectToPrimary *RegisterArtworkRequest_ConnectToPrimaryRequest `protobuf:"bytes,3,opt,name=connect_to_primary,json=connectToPrimary,proto3,oneof"`
}
...
func (*RegisterArtworkRequest_SecondaryNodes) isRegisterArtworkRequest_Requests() {}

func (*RegisterArtworkRequest_ConnectToPrimary) isRegisterArtworkRequest_Requests() {}
...
type RegisterArtworkReply struct {
	...
	//	*RegisterArtworkReply_SecondaryNodes
	//	*RegisterArtworkReply_ConnectToPrimary
...
func (x *RegisterArtworkReply) GetSecondaryNodes() *RegisterArtworkReply_SecondaryNodesReply {
	if x, ok := x.GetReplies().(*RegisterArtworkReply_SecondaryNodes); ok {
		return x.SecondaryNodes
	}
	return nil
}

func (x *RegisterArtworkReply) GetConnectToPrimary() *RegisterArtworkReply_ConnectToPrimaryReply {
	if x, ok := x.GetReplies().(*RegisterArtworkReply_ConnectToPrimary); ok {
		return x.ConnectToPrimary
	}
	return nil
}
...
type RegisterArtworkReply_SecondaryNodes struct {
	SecondaryNodes *RegisterArtworkReply_SecondaryNodesReply `protobuf:"bytes,2,opt,name=secondary_nodes,json=secondaryNodes,proto3,oneof"`
}

type RegisterArtworkReply_ConnectToPrimary struct {
	ConnectToPrimary *RegisterArtworkReply_ConnectToPrimaryReply `protobuf:"bytes,3,opt,name=connect_to_primary,json=connectToPrimary,proto3,oneof"`
}
...
func (*RegisterArtworkReply_SecondaryNodes) isRegisterArtworkReply_Replies() {}

func (*RegisterArtworkReply_ConnectToPrimary) isRegisterArtworkReply_Replies() {}
...
type RegisterArtworkRequest_SecondaryNodesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *RegisterArtworkRequest_SecondaryNodesRequest) Reset() {
	*x = RegisterArtworkRequest_SecondaryNodesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkRequest_SecondaryNodesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkRequest_SecondaryNodesRequest) ProtoMessage() {}

func (x *RegisterArtworkRequest_SecondaryNodesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkRequest_SecondaryNodesRequest.ProtoReflect.Descriptor instead.
func (*RegisterArtworkRequest_SecondaryNodesRequest) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{0, 1}
}

type RegisterArtworkRequest_ConnectToPrimaryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterArtworkRequest_ConnectToPrimaryRequest) Reset() {
	*x = RegisterArtworkRequest_ConnectToPrimaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkRequest_ConnectToPrimaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkRequest_ConnectToPrimaryRequest) ProtoMessage() {}

func (x *RegisterArtworkRequest_ConnectToPrimaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkRequest_ConnectToPrimaryRequest.ProtoReflect.Descriptor instead.
func (*RegisterArtworkRequest_ConnectToPrimaryRequest) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{0, 2}
}

func (x *RegisterArtworkRequest_ConnectToPrimaryRequest) GetNodeKey() string {
	if x != nil {
		return x.NodeKey
	}
	return ""
...
type RegisterArtworkReply_SecondaryNodesReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Peers []*RegisterArtworkReply_SecondaryNodesReply_Peer `protobuf:"bytes,1,rep,name=peers,proto3" json:"peers,omitempty"`
	Error *RegisterArtworkReply_Error                      `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}

func (x *RegisterArtworkReply_SecondaryNodesReply) Reset() {
	*x = RegisterArtworkReply_SecondaryNodesReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkReply_SecondaryNodesReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkReply_SecondaryNodesReply) ProtoMessage() {}

func (x *RegisterArtworkReply_SecondaryNodesReply) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkReply_SecondaryNodesReply.ProtoReflect.Descriptor instead.
func (*RegisterArtworkReply_SecondaryNodesReply) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{1, 2}
}

func (x *RegisterArtworkReply_SecondaryNodesReply) GetPeers() []*RegisterArtworkReply_SecondaryNodesReply_Peer {
	if x != nil {
		return x.Peers
	}
	return nil
...
func (x *RegisterArtworkReply_SecondaryNodesReply) GetError() *RegisterArtworkReply_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type RegisterArtworkReply_ConnectToPrimaryReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterArtworkReply_ConnectToPrimaryReply) Reset() {
	*x = RegisterArtworkReply_ConnectToPrimaryReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkReply_ConnectToPrimaryReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkReply_ConnectToPrimaryReply) ProtoMessage() {}

func (x *RegisterArtworkReply_ConnectToPrimaryReply) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkReply_ConnectToPrimaryReply.ProtoReflect.Descriptor instead.
func (*RegisterArtworkReply_ConnectToPrimaryReply) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{1, 3}
}

func (x *RegisterArtworkReply_ConnectToPrimaryReply) GetError() *RegisterArtworkReply_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type RegisterArtworkReply_SecondaryNodesReply_Peer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterArtworkReply_SecondaryNodesReply_Peer) Reset() {
	*x = RegisterArtworkReply_SecondaryNodesReply_Peer{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterArtworkReply_SecondaryNodesReply_Peer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterArtworkReply_SecondaryNodesReply_Peer) ProtoMessage() {}

func (x *RegisterArtworkReply_SecondaryNodesReply_Peer) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_walletnode_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterArtworkReply_SecondaryNodesReply_Peer.ProtoReflect.Descriptor instead.
func (*RegisterArtworkReply_SecondaryNodesReply_Peer) Descriptor() ([]byte, []int) {
	return file_walletnode_walletnode_proto_rawDescGZIP(), []int{1, 2, 0}
}

func (x *RegisterArtworkReply_SecondaryNodesReply_Peer) GetNodeKey() string {
	if x != nil {
		return x.NodeKey
	}
	return ""
...
var file_walletnode_walletnode_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x6c, 0x65, 0x74, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0x92, 0x07, 0x0a, 0x16, 0x52, 0x65,
	...
	0x68, 0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x12, 0x63, 0x0a, 0x0f, 0x73, 0x65, 0x63,
	0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x1a, 0xca, 0x01, 0x0a, 0x11, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x69,
	...
	,
	...
	,
	...
	0x48, 0x00, 0x52, 0x0a, 0x73, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x1a, 0x81,
	0x01, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x45, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65,
	...
	0x10, 0x01, 0x1a, 0x4e, 0x0a, 0x0e, 0x48, 0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x3c, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x6e, 0x6f, 0x64, 0x65,
	...
	,
	...
	,
	...
	0x6e, 0x6f, 0x64, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_walletnode_walletnode_proto_goTypes = []interface{}{
	...
	(*RegisterArtworkRequest_SecondaryNodesRequest)(nil),   // 4: walletnode.RegisterArtworkRequest.SecondaryNodesRequest
	(*RegisterArtworkRequest_ConnectToPrimaryRequest)(nil), // 5: walletnode.RegisterArtworkRequest.ConnectToPrimaryRequest
	...
	(*RegisterArtworkReply_SecondaryNodesReply)(nil),       // 10: walletnode.RegisterArtworkReply.SecondaryNodesReply
	(*RegisterArtworkReply_ConnectToPrimaryReply)(nil),     // 11: walletnode.RegisterArtworkReply.ConnectToPrimaryReply
	...
	(*RegisterArtworkReply_SecondaryNodesReply_Peer)(nil),  // 14: walletnode.RegisterArtworkReply.SecondaryNodesReply.Peer
}
var file_walletnode_walletnode_proto_depIdxs = []int32{
	...
	4,  // 1: walletnode.RegisterArtworkRequest.secondary_nodes:type_name -> walletnode.RegisterArtworkRequest.SecondaryNodesRequest
	5,  // 2: walletnode.RegisterArtworkRequest.connect_to_primary:type_name -> walletnode.RegisterArtworkRequest.ConnectToPrimaryRequest
	...
	10, // 6: walletnode.RegisterArtworkReply.secondary_nodes:type_name -> walletnode.RegisterArtworkReply.SecondaryNodesReply
	11, // 7: walletnode.RegisterArtworkReply.connect_to_primary:type_name -> walletnode.RegisterArtworkReply.ConnectToPrimaryReply
	...
	14, // 12: walletnode.RegisterArtworkReply.SecondaryNodesReply.peers:type_name -> walletnode.RegisterArtworkReply.SecondaryNodesReply.Peer
	8,  // 13: walletnode.RegisterArtworkReply.SecondaryNodesReply.error:type_name -> walletnode.RegisterArtworkReply.Error
	8,  // 14: walletnode.RegisterArtworkReply.ConnectToPrimaryReply.error:type_name -> walletnode.RegisterArtworkReply.Error
...
func file_walletnode_walletnode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_walletnode_walletnode_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkRequest_SecondaryNodesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkRequest_ConnectToPrimaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkReply_SecondaryNodesReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkReply_ConnectToPrimaryReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_walletnode_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterArtworkReply_SecondaryNodesReply_Peer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_walletnode_walletnode_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*RegisterArtworkRequest_SecondaryNodes)(nil),
		(*RegisterArtworkRequest_ConnectToPrimary)(nil),
	...
	file_walletnode_walletnode_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*RegisterArtworkReply_SecondaryNodes)(nil),
		(*RegisterArtworkReply_ConnectToPrimary)(nil),
