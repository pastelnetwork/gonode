...
var file_register_collection_wn_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x67, 0x54, 0x78, 0x69, 0x64, 0x32, 0xca, 0x03, 0x0a, 0x12, 0x52,
...
var file_register_collection_wn_proto_goTypes = []interface{}{
	...
	(*SessionReply)(nil),                             // 6: walletnode.SessionReply
	(*AcceptedNodesReply)(nil),                       // 7: walletnode.AcceptedNodesReply
	(*ConnectToReply)(nil),                           // 8: walletnode.ConnectToReply
	(*MeshNodesReply)(nil),                           // 9: walletnode.MeshNodesReply
}
var file_register_collection_wn_proto_depIdxs = []int32{
	...
	6, // 5: walletnode.RegisterCollection.Session:output_type -> walletnode.SessionReply
	7, // 6: walletnode.RegisterCollection.AcceptedNodes:output_type -> walletnode.AcceptedNodesReply
	8, // 7: walletnode.RegisterCollection.ConnectTo:output_type -> walletnode.ConnectToReply
	9, // 8: walletnode.RegisterCollection.MeshNodes:output_type -> walletnode.MeshNodesReply
	1, // 9: walletnode.RegisterCollection.SendCollectionTicketForSignature:output_type -> walletnode.SendCollectionTicketForSignatureResponse
