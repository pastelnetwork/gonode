...
var file_register_nft_wn_proto_rawDesc = []byte{
	...
	0x87, 0x07, 0x0a, 0x0b, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x4e, 0x66, 0x74, 0x12,
	...
	0x48, 0x61, 0x73, 0x68, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74,
...
var file_register_nft_wn_proto_goTypes = []interface{}{
	...
	(*SessionReply)(nil),                  // 18: walletnode.SessionReply
	(*AcceptedNodesReply)(nil),            // 19: walletnode.AcceptedNodesReply
	(*ConnectToReply)(nil),                // 20: walletnode.ConnectToReply
	(*MeshNodesReply)(nil),                // 21: walletnode.MeshNodesReply
	(*SendRegMetadataReply)(nil),          // 22: walletnode.SendRegMetadataReply
	(*ProbeImageReply)(nil),               // 23: walletnode.ProbeImageReply
	(*DBHashReply)(nil),                   // 24: walletnode.DBHashReply
}
var file_register_nft_wn_proto_depIdxs = []int32{
	...
	18, // 14: walletnode.RegisterNft.Session:output_type -> walletnode.SessionReply
	19, // 15: walletnode.RegisterNft.AcceptedNodes:output_type -> walletnode.AcceptedNodesReply
	20, // 16: walletnode.RegisterNft.ConnectTo:output_type -> walletnode.ConnectToReply
	21, // 17: walletnode.RegisterNft.MeshNodes:output_type -> walletnode.MeshNodesReply
	22, // 18: walletnode.RegisterNft.SendRegMetadata:output_type -> walletnode.SendRegMetadataReply
	23, // 19: walletnode.RegisterNft.ProbeImage:output_type -> walletnode.ProbeImageReply
	1,  // 20: walletnode.RegisterNft.SendSignedNFTTicket:output_type -> walletnode.SendSignedNFTTicketReply
	3,  // 21: walletnode.RegisterNft.SendPreBurntFeeTxid:output_type -> walletnode.SendPreBurntFeeTxidReply
	5,  // 22: walletnode.RegisterNft.SendTicket:output_type -> walletnode.SendTicketReply
	7,  // 23: walletnode.RegisterNft.UploadImage:output_type -> walletnode.UploadImageReply
	24, // 24: walletnode.RegisterNft.GetDDDatabaseHash:output_type -> walletnode.DBHashReply
