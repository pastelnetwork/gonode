...
type RegisterCascadeClient interface {
	...
	ProbeImage(ctx context.Context, opts ...grpc.CallOption) (RegisterCascade_ProbeImageClient, error)
...
func (c *registerCascadeClient) AcceptedNodes(ctx context.Context, in *AcceptedNodesRequest, opts ...grpc.CallOption) (*AcceptedNodesReply, error) {
	...
	err := c.cc.Invoke(ctx, "/register_cascade.RegisterCascade/AcceptedNodes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registerCascadeClient) ConnectTo(ctx context.Context, in *ConnectToRequest, opts ...grpc.CallOption) (*ConnectToReply, error) {
	...
	err := c.cc.Invoke(ctx, "/register_cascade.RegisterCascade/ConnectTo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registerCascadeClient) MeshNodes(ctx context.Context, in *MeshNodesRequest, opts ...grpc.CallOption) (*MeshNodesReply, error) {
	...
	err := c.cc.Invoke(ctx, "/register_cascade.RegisterCascade/MeshNodes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registerCascadeClient) SendRegMetadata(ctx context.Context, in *SendRegMetadataRequest, opts ...grpc.CallOption) (*SendRegMetadataReply, error) {
	...
	err := c.cc.Invoke(ctx, "/register_cascade.RegisterCascade/SendRegMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registerCascadeClient) ProbeImage(ctx context.Context, opts ...grpc.CallOption) (RegisterCascade_ProbeImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &RegisterCascade_ServiceDesc.Streams[1], "/register_cascade.RegisterCascade/ProbeImage", opts...)
	if err != nil {
		return nil, err
	}
	x := &registerCascadeProbeImageClient{stream}
	return x, nil
}

type RegisterCascade_ProbeImageClient interface {
	Send(*ProbeImageRequest) error
	CloseAndRecv() (*ProbeImageReply, error)
	grpc.ClientStream
}

type registerCascadeProbeImageClient struct {
	grpc.ClientStream
}

func (x *registerCascadeProbeImageClient) Send(m *ProbeImageRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *registerCascadeProbeImageClient) CloseAndRecv() (*ProbeImageReply, error) {
...
func (c *registerCascadeClient) SendSignedActionTicket(ctx context.Context, in *SendSignedActionTicketRequest, opts ...grpc.CallOption) (*SendSignedActionTicketReply, error) {
	out := new(SendSignedActionTicketReply)
	err := c.cc.Invoke(ctx, "/register_cascade.RegisterCascade/SendSignedActionTicket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registerCascadeClient) SendActionAct(ctx context.Context, in *SendActionActRequest, opts ...grpc.CallOption) (*SendActionActReply, error) {
	...
	err := c.cc.Invoke(ctx, "/register_cascade.RegisterCascade/SendActionAct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegisterCascadeServer interface {
	...
	// ProbeImage uploads the resampled image compute/burn txid and return a fingerpirnt and MN signature.
	ProbeImage(RegisterCascade_ProbeImageServer) error
	// SendArtTicket sends a signed art-ticket to the supernode.
...
func (UnimplementedRegisterCascadeServer) ProbeImage(RegisterCascade_ProbeImageServer) error {
	return status.Errorf(codes.Unimplemented, "method ProbeImage not implemented")
}
func (UnimplementedRegisterCascadeServer) SendSignedActionTicket(context.Context, *SendSignedActionTicketRequest) (*SendSignedActionTicketReply, error) {
...
func _RegisterCascade_AcceptedNodes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register_cascade.RegisterCascade/AcceptedNodes",
	}
...
func _RegisterCascade_ConnectTo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register_cascade.RegisterCascade/ConnectTo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RegisterCascade_MeshNodes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register_cascade.RegisterCascade/MeshNodes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RegisterCascade_SendRegMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register_cascade.RegisterCascade/SendRegMetadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RegisterCascade_ProbeImage_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RegisterCascadeServer).ProbeImage(&registerCascadeProbeImageServer{stream})
}

type RegisterCascade_ProbeImageServer interface {
	SendAndClose(*ProbeImageReply) error
	Recv() (*ProbeImageRequest, error)
	grpc.ServerStream
}

type registerCascadeProbeImageServer struct {
	grpc.ServerStream
}

func (x *registerCascadeProbeImageServer) SendAndClose(m *ProbeImageReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *registerCascadeProbeImageServer) Recv() (*ProbeImageRequest, error) {
...
func _RegisterCascade_SendSignedActionTicket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register_cascade.RegisterCascade/SendSignedActionTicket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterCascadeServer).SendSignedActionTicket(ctx, req.(*SendSignedActionTicketRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RegisterCascade_SendActionAct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register_cascade.RegisterCascade/SendActionAct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RegisterCascade_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _RegisterCascade_ProbeImage_Handler,
			ClientStreams: true,
		},
	},
