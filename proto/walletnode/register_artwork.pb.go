...
func (x *UploadImageRequest) GetThumbnail() *UploadImageRequest_Coordinate {
	if x, ok := x.GetPayload().(*UploadImageRequest_Thumbnail); ok {
		return x.Thumbnail
	}
	return nil
}
...
type UploadImageRequest_Thumbnail struct {
	// Should be included in the last piece of image only
	Thumbnail *UploadImageRequest_Coordinate `protobuf:"bytes,2,opt,name=thumbnail,proto3,oneof"`
}

func (*UploadImageRequest_ImagePiece) isUploadImageRequest_Payload() {}

func (*UploadImageRequest_Thumbnail) isUploadImageRequest_Payload() {}
...
var file_walletnode_register_artwork_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x54, 0x78, 0x69, 0x64, 0x22, 0xa4, 0x02, 0x0a,
	0x12, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0b, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x70, 0x69, 0x65,
	0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x0a, 0x69, 0x6d, 0x61, 0x67,
	0x65, 0x50, 0x69, 0x65, 0x63, 0x65, 0x12, 0x49, 0x0a, 0x09, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x6e,
	0x61, 0x69, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x77, 0x61, 0x6c, 0x6c,
	...
	0x6e, 0x61, 0x74, 0x65, 0x48, 0x00, 0x52, 0x09, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x6e, 0x61, 0x69,
	0x6c, 0x1a, 0x94, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x61, 0x74, 0x65,
	...
	0x6f, 0x6d, 0x52, 0x69, 0x67, 0x68, 0x74, 0x59, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c,
	...
	0x0d, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x6e, 0x61, 0x69, 0x6c, 0x48, 0x61, 0x73, 0x68, 0x32, 0xd5,
...
var file_walletnode_register_artwork_proto_goTypes = []interface{}{
	...
	(*UploadImageRequest_Coordinate)(nil), // 13: walletnode.UploadImageRequest.Coordinate
}
var file_walletnode_register_artwork_proto_depIdxs = []int32{
	...
	13, // 1: walletnode.UploadImageRequest.thumbnail:type_name -> walletnode.UploadImageRequest.Coordinate
...
func file_walletnode_register_artwork_proto_init() {
	...
	file_walletnode_register_artwork_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*UploadImageRequest_ImagePiece)(nil),
		(*UploadImageRequest_Thumbnail)(nil),
	}
	type x struct{}
