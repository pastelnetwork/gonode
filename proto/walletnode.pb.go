...
type WalletNodeRegisterArtworkRequest struct {
	...
	//	*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodes
	//	*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNode
...
func (x *WalletNodeRegisterArtworkRequest) GetAcceptSecondaryNodes() *WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest {
	if x, ok := x.GetTestOneof().(*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodes); ok {
		return x.AcceptSecondaryNodes
	}
	return nil
}

func (x *WalletNodeRegisterArtworkRequest) GetConnectToPrimaryNode() *WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest {
	if x, ok := x.GetTestOneof().(*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNode); ok {
		return x.ConnectToPrimaryNode
	}
	return nil
}
...
type WalletNodeRegisterArtworkRequest_AcceptSecondaryNodes struct {
	AcceptSecondaryNodes *WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest `protobuf:"bytes,1,opt,name=accept_secondary_nodes,json=acceptSecondaryNodes,proto3,oneof"`
}

type WalletNodeRegisterArtworkRequest_ConnectToPrimaryNode struct {
	ConnectToPrimaryNode *WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest `protobuf:"bytes,2,opt,name=connect_to_primary_node,json=connectToPrimaryNode,proto3,oneof"`
}
...
func (*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodes) isWalletNodeRegisterArtworkRequest_TestOneof() {
}

func (*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNode) isWalletNodeRegisterArtworkRequest_TestOneof() {
}
...
type WalletNodeRegisterArtworkReply struct {
	...
	// Types that are assignable to TestOneof:
	//	*WalletNodeRegisterArtworkReply_AcceptSecondaryNodes
	//	*WalletNodeRegisterArtworkReply_ConnectToPrimaryNode
...
func (x *WalletNodeRegisterArtworkReply) GetAcceptSecondaryNodes() *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply {
	if x, ok := x.GetTestOneof().(*WalletNodeRegisterArtworkReply_AcceptSecondaryNodes); ok {
		return x.AcceptSecondaryNodes
	}
	return nil
}

func (x *WalletNodeRegisterArtworkReply) GetConnectToPrimaryNode() *WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply {
	if x, ok := x.GetTestOneof().(*WalletNodeRegisterArtworkReply_ConnectToPrimaryNode); ok {
		return x.ConnectToPrimaryNode
	}
	return nil
}
...
type WalletNodeRegisterArtworkReply_AcceptSecondaryNodes struct {
	AcceptSecondaryNodes *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply `protobuf:"bytes,1,opt,name=accept_secondary_nodes,json=acceptSecondaryNodes,proto3,oneof"`
}

type WalletNodeRegisterArtworkReply_ConnectToPrimaryNode struct {
	ConnectToPrimaryNode *WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply `protobuf:"bytes,2,opt,name=connect_to_primary_node,json=connectToPrimaryNode,proto3,oneof"`
}
...
func (*WalletNodeRegisterArtworkReply_AcceptSecondaryNodes) isWalletNodeRegisterArtworkReply_TestOneof() {
}

func (*WalletNodeRegisterArtworkReply_ConnectToPrimaryNode) isWalletNodeRegisterArtworkReply_TestOneof() {
}
...
type WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest) Reset() {
	*x = WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest) ProtoMessage() {}

func (x *WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest.ProtoReflect.Descriptor instead.
func (*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest) Descriptor() ([]byte, []int) {
	return file_walletnode_proto_rawDescGZIP(), []int{0, 0}
}

func (x *WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest) GetConnID() string {
	if x != nil {
		return x.ConnID
	}
	return ""
...
type WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest) Reset() {
	*x = WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest) ProtoMessage() {}

func (x *WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest.ProtoReflect.Descriptor instead.
func (*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest) Descriptor() ([]byte, []int) {
	return file_walletnode_proto_rawDescGZIP(), []int{0, 1}
}

func (x *WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest) GetConnID() string {
	if x != nil {
		return x.ConnID
	}
	return ""
...
func (x *WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest) GetPrimaryNodeKey() string {
	if x != nil {
...
type WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Peers []*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer `protobuf:"bytes,1,rep,name=peers,proto3" json:"peers,omitempty"`
	Error *WalletNodeRegisterArtworkReply_Error                            `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}

func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply) Reset() {
	*x = WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply) ProtoMessage() {}

func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply.ProtoReflect.Descriptor instead.
func (*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply) Descriptor() ([]byte, []int) {
	return file_walletnode_proto_rawDescGZIP(), []int{1, 1}
}

func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply) GetPeers() []*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer {
	if x != nil {
		return x.Peers
	}
	return nil
...
func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply) GetError() *WalletNodeRegisterArtworkReply_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply) Reset() {
	*x = WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply) ProtoMessage() {}

func (x *WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply.ProtoReflect.Descriptor instead.
func (*WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply) Descriptor() ([]byte, []int) {
	return file_walletnode_proto_rawDescGZIP(), []int{1, 2}
}

func (x *WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply) GetError() *WalletNodeRegisterArtworkReply_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer) Reset() {
	*x = WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer{}
	if protoimpl.UnsafeEnabled {
...
func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer) ProtoMessage() {}

func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer) ProtoReflect() protoreflect.Message {
	mi := &file_walletnode_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer.ProtoReflect.Descriptor instead.
func (*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer) Descriptor() ([]byte, []int) {
	return file_walletnode_proto_rawDescGZIP(), []int{1, 1, 0}
}

func (x *WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer) GetSecondaryKey() string {
	if x != nil {
...
var file_walletnode_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfb, 0x06, 0x0a, 0x20, 0x57, 0x61,
	0x6c, 0x6c, 0x65, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	0x41, 0x72, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x7b,
	0x0a, 0x16, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x5f, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x61,
	0x72, 0x79, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x43,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x53, 0x65,
	0x63, 0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x14, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x53, 0x65, 0x63,
	0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x12, 0x7c, 0x0a, 0x17, 0x63,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x5f, 0x74, 0x6f, 0x5f, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72,
	0x79, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x70,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x6b, 0x65, 0x74, 0x1a, 0x86, 0x01, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x4a,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x1a, 0x75, 0x0a, 0x0f, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74,
	...
	,
	...
	0x74, 0x1a, 0x25, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74,
	0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x41, 0x72, 0x74, 0x77,
	0x6f, 0x72, 0x6b, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x28, 0x01, 0x30, 0x01, 0x42, 0x27, 0x5a, 0x25,
...
var file_walletnode_proto_goTypes = []interface{}{
	...
	(*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest)(nil),  // 3: proto.WalletNodeRegisterArtworkRequest.AcceptSecondaryNodesRequest
	(*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest)(nil),  // 4: proto.WalletNodeRegisterArtworkRequest.ConnectToPrimaryNodeRequest
	...
	(*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply)(nil),      // 8: proto.WalletNodeRegisterArtworkReply.AcceptSecondaryNodesReply
	(*WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply)(nil),      // 9: proto.WalletNodeRegisterArtworkReply.ConnectToPrimaryNodeReply
	...
	(*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer)(nil), // 12: proto.WalletNodeRegisterArtworkReply.AcceptSecondaryNodesReply.Peer
}
var file_walletnode_proto_depIdxs = []int32{
	3,  // 0: proto.WalletNodeRegisterArtworkRequest.accept_secondary_nodes:type_name -> proto.WalletNodeRegisterArtworkRequest.AcceptSecondaryNodesRequest
	4,  // 1: proto.WalletNodeRegisterArtworkRequest.connect_to_primary_node:type_name -> proto.WalletNodeRegisterArtworkRequest.ConnectToPrimaryNodeRequest
	...
	8,  // 4: proto.WalletNodeRegisterArtworkReply.accept_secondary_nodes:type_name -> proto.WalletNodeRegisterArtworkReply.AcceptSecondaryNodesReply
	9,  // 5: proto.WalletNodeRegisterArtworkReply.connect_to_primary_node:type_name -> proto.WalletNodeRegisterArtworkReply.ConnectToPrimaryNodeReply
	...
	12, // 9: proto.WalletNodeRegisterArtworkReply.AcceptSecondaryNodesReply.peers:type_name -> proto.WalletNodeRegisterArtworkReply.AcceptSecondaryNodesReply.Peer
	7,  // 10: proto.WalletNodeRegisterArtworkReply.AcceptSecondaryNodesReply.error:type_name -> proto.WalletNodeRegisterArtworkReply.Error
	7,  // 11: proto.WalletNodeRegisterArtworkReply.ConnectToPrimaryNodeReply.error:type_name -> proto.WalletNodeRegisterArtworkReply.Error
...
func file_walletnode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_walletnode_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNodeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WalletNodeRegisterArtworkReply_ConnectToPrimaryNodeReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletnode_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WalletNodeRegisterArtworkReply_AcceptSecondaryNodesReply_Peer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_walletnode_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*WalletNodeRegisterArtworkRequest_AcceptSecondaryNodes)(nil),
		(*WalletNodeRegisterArtworkRequest_ConnectToPrimaryNode)(nil),
	...
	file_walletnode_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*WalletNodeRegisterArtworkReply_AcceptSecondaryNodes)(nil),
		(*WalletNodeRegisterArtworkReply_ConnectToPrimaryNode)(nil),
