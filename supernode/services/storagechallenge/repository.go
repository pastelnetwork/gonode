...
type Repository interface {
	...
	// GetListOfSupernode func
	GetListOfSupernode(ctx context.Context) ([]string, error)
	// GetNClosestSupernodeIDsToComparisonString func
	GetNClosestSupernodeIDsToComparisonString(ctx context.Context, n int, comparisonString string, listSupernodes []string, ignores ...string) []string
	// GetNClosestSupernodesToAGivenFileUsingKademlia func
	GetNClosestSupernodesToAGivenFileUsingKademlia(ctx context.Context, n int, comparisonString string, ignores ...string) []string
...
func (r *repo) GetListOfSupernode(ctx context.Context) ([]string, error) {
...
func (r *repo) GetNClosestSupernodeIDsToComparisonString(_ context.Context, n int, comparisonString string, listSupernodes []string, ignores ...string) []string {
	return utils.GetNClosestXORDistanceStringToAGivenComparisonString(n, comparisonString, listSupernodes, ignores...)
}

func (r *repo) GetNClosestSupernodesToAGivenFileUsingKademlia(ctx context.Context, n int, comparisonString string, ignores ...string) []string {
