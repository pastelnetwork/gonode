...
func (client *Client) ListenOnRegisterNft() *Client {
	client.Connection.On(RegisterNftMethod).Return(client.RegisterNft)
	return client
}
...
func (client *Client) AssertRegisterNftCall(expectedCalls int, arguments ...interface{}) *Client {
	if expectedCalls > 0 {
		client.Connection.AssertCalled(client.t, RegisterNftMethod, arguments...)
	}
	client.Connection.AssertNumberOfCalls(client.t, RegisterNftMethod, expectedCalls)
	return client
}
...
func (client *Client) AssertDownloadNftCall(expectedCalls int, arguments ...interface{}) *Client {
	if expectedCalls > 0 {
		client.Connection.AssertCalled(client.t, DownloadNftMethod, arguments...)
	}
	client.Connection.AssertNumberOfCalls(client.t, DownloadNftMethod, expectedCalls)
	return client
}
...
func (client *Client) ListenOnSendNftTicketSignature(returnErr error) *Client {
	client.RegisterNft.On(SendNftTicketSignatureMethod, mock.Anything, mock.Anything, mock.Anything).Return(returnErr)
	return client
}
...
func (client *Client) ListenOnSendSignedDDAndFingerprints(returnErr error) *Client {
	client.RegisterNft.On(SendSignedDDAndFingerprintsMethod, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(returnErr)
	return client
}
...
func (client *Client) ListenOnConnectTo(returnErr error) *Client {
	client.RegisterNft.On(ConnectToMethod, mock.Anything, mock.IsType(string("")), mock.IsType(string(""))).Return(returnErr)
	return client
}
