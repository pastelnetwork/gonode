...
# each class is a unique folder containing images / categories
colors_per_class = {
    #'dog' : [254, 202, 87],
    #'horse' : [255, 107, 107],
    #'elephant' : [10, 189, 227],
...
# This is a reference howto use for example on multiple images
...
class OriginalImagesDataset(torch.utils.data.Dataset):
