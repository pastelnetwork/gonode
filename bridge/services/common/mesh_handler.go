...
type MeshHandler struct {
	...
	nodeClient node.SNClientInterface
...
func NewMeshHandlerSimple(nodeClient node.SNClientInterface, nodeMaker node.RealNodeMaker, pastelHandler *mixins.PastelHandler) *MeshHandler {
	return &MeshHandler{
		nodeMaker:     nodeMaker,
