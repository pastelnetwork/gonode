...
func NewSearchRequestResponseBody(res *artworks.ArtworkTicket) *SearchRequestResponseBody {
...
// NewSearchRequestPayload builds a artworks service searchRequest endpoint
// payload.
func NewSearchRequestPayload(term string) *artworks.SearchRequestPayload {
	v := &artworks.SearchRequestPayload{}
	v.Term = &term
