...
// NewSearchRequestArtworkTicketOK builds a "artworks" service "searchRequest"
// endpoint result from a HTTP "OK" response.
func NewSearchRequestArtworkTicketOK(body *SearchRequestResponseBody) *artworks.ArtworkTicket {
...
// ValidateSearchRequestResponseBody runs the validations defined on
// SearchRequestResponseBody
func ValidateSearchRequestResponseBody(body *SearchRequestResponseBody) (err error) {
