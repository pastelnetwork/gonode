...
import (
	...
	swagger "github.com/pastelnetwork/gonode/walletnode/gen/swagger"
...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountHTTPOpenapi3JSON(mux, goahttp.ReplacePrefix("/swagger/swagger.json", "/http/openapi3.json", h.HTTPOpenapi3JSON))
}
