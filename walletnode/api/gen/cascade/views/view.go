...
var (
	...
	// ActionDetailResultMap is a map of attribute names in result type
	// ActionDetailResult indexed by view name.
	ActionDetailResultMap = map[string][]string{
		"default": []string{
			"estimated_fee",
		},
	}
	// StartProcessingResultMap is a map of attribute names in result type
	// StartProcessingResult indexed by view name.
