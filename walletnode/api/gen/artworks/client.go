...
func NewClient(register, registerTaskState, registerTask, registerTasks, uploadImage, search goa.Endpoint) *Client {
	return &Client{
...
// Search calls the "search" endpoint of the "artworks" service.
func (c *Client) Search(ctx context.Context, p *SearchPayload) (res SearchClientStream, err error) {
	var ires interface{}
	ires, err = c.SearchEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(SearchClientStream), nil
}
