...
// SearchResponseBody is the type of the "artworks" service "search" endpoint
// HTTP response body.
...
// SearchBadRequestResponseBody is the type of the "artworks" service "search"
...
// SearchInternalServerErrorResponseBody is the type of the "artworks" service
// "search" endpoint HTTP response body for the "InternalServerError" error.
type SearchInternalServerErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name *string `form:"name,omitempty" json:"name,omitempty" xml:"name,omitempty"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID *string `form:"id,omitempty" json:"id,omitempty" xml:"id,omitempty"`
...
// NewSearchArtworkTicketOK builds a "artworks" service "search" endpoint
// result from a HTTP "OK" response.
func NewSearchArtworkTicketOK(body *SearchResponseBody) *artworks.ArtworkTicket {
	v := &artworks.ArtworkTicket{
		Name:                     *body.Name,
...
// NewSearchBadRequest builds a artworks service search endpoint BadRequest
// error.
...
// NewSearchInternalServerError builds a artworks service search endpoint
// InternalServerError error.
func NewSearchInternalServerError(body *SearchInternalServerErrorResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// search_BadRequest_response_body
...
// ValidateSearchInternalServerErrorResponseBody runs the validations defined
// on search_InternalServerError_response_body
func ValidateSearchInternalServerErrorResponseBody(body *SearchInternalServerErrorResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
