...
func BuildUploadImagePayload(artworksUploadImageBody string) (*artworks.UploadImagePayload, error) {
	...
	var body UploadImageRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"file\": \"RG9sb3JlcyB1dCBmdWdpdCB0ZW1wb3JhIHBlcmZlcmVuZGlzIGRvbG9yaWJ1cyBxdWlzcXVhbS4=\"\n   }'")
		}
		if body.Bytes == nil {
...
// BuildSearchPayload builds the payload for the artworks search endpoint from
// CLI flags.
func BuildSearchPayload(artworksSearchTerm string) (*artworks.SearchPayload, error) {
	var term string
	{
		term = artworksSearchTerm
	}
