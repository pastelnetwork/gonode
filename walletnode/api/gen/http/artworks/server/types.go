...
// "search" endpoint of the "artworks" service.
func NewSearchResponseBody(res *artworks.ArtworkTicket) *SearchResponseBody {
...
// result of the "search" endpoint of the "artworks" service.
...
// NewSearchInternalServerErrorResponseBody builds the HTTP response body from
// the result of the "search" endpoint of the "artworks" service.
func NewSearchInternalServerErrorResponseBody(res *goa.ServiceError) *SearchInternalServerErrorResponseBody {
	body := &SearchInternalServerErrorResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSearchPayload builds a artworks service search endpoint payload.
func NewSearchPayload(term string) *artworks.SearchPayload {
	v := &artworks.SearchPayload{}
	v.Term = &term
