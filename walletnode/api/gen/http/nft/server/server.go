...
func MountCORSHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("OPTIONS", "/nfts/register", f)
	mux.Handle("OPTIONS", "/nfts/register/{taskId}/state", f)
	mux.Handle("OPTIONS", "/nfts/register/{taskId}", f)
	mux.Handle("OPTIONS", "/nfts/register/upload", f)
	mux.Handle("OPTIONS", "/nfts/search", f)
	mux.Handle("OPTIONS", "/nfts/{txid}", f)
	mux.Handle("OPTIONS", "/nfts/download", f)
}
