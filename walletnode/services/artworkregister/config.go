...
type Config struct {
	...
	DDAndFingerprintsMax uint16 `mapstructure:"dd_and_fingerprints_max" json:"dd_and_fingerprints_max,omitempty"`
	RQIDsMax             uint16 `mapstructure:"rq_ids_max" json:"rq_ids_max,omitempty"`
	// internal settings
