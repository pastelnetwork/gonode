...
type RPCClient interface {
	...
	CallRawWithContext(ctx context.Context, request *RPCRequest) (*RPCResponse, error)
...
func (client *rpcClient) CallWithContext(ctx context.Context, method string, params ...interface{}) (*RPCResponse, error) {
	...
	b.MaxElapsedTime = 6 * time.Second // after this time, no more retries; ensures 3 retries
	// Define the operation to be retried.
	operation := func() error {
		gctx, cancel := context.WithTimeout(ctx, timeout)
		defer cancel()

		resp, err = client.doCall(gctx, request)
		return err
	}
...
func (client *rpcClient) Call(method string, params ...interface{}) (*RPCResponse, error) {
	return client.CallWithContext(context.Background(), method, params...)
}

func (client *rpcClient) CallRawWithContext(ctx context.Context, request *RPCRequest) (*RPCResponse, error) {
	return client.doCall(ctx, request)
}

func (client *rpcClient) CallRaw(request *RPCRequest) (*RPCResponse, error) {
	return client.CallRawWithContext(context.Background(), request)
}
...
func (client *rpcClient) CallFor(out interface{}, method string, params ...interface{}) error {
	return client.CallForWithContext(context.Background(), out, method, params...)
}
