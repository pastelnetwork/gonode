...
COPY /integration/p2p/configs/sn1.yml /supernode/sn1.yml
COPY /integration/p2p/configs/sn2.yml /supernode/sn2.yml
COPY /integration/p2p/configs/sn3.yml /supernode/sn3.yml
COPY /integration/p2p/configs/pastel.conf /supernode/pastel.conf
