...
func NewFingerprintService(fgStore store.DDStore, pastelClient pastel.Client, hp2p node.HermesP2PInterface, s *synchronizer.Synchronizer) (service.SvcInterface, error) {
