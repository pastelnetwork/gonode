...
"{}/pasteld -datadir={}/node10 -daemon -keypool=1 -discover=0 -rest -debug=masternode,mnpayments,governance -txindex=1 -reindex".format(PASTELD_DIR, EXTRACT_PATH_FULL),
"{}/pasteld -datadir={}/node11 -daemon -keypool=1 -discover=0 -rest -debug=masternode,mnpayments,governance -txindex=1 -reindex".format(PASTELD_DIR, EXTRACT_PATH_FULL),
"{}/pasteld -datadir={}/node12 -daemon -keypool=1 -discover=0 -rest -debug=masternode,mnpayments,governance -txindex=1 -reindex".format(PASTELD_DIR, EXTRACT_PATH_FULL),
